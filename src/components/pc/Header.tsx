      ...
      <div id="header_app" className="header-app-root is-pcDesignUpdated" >
        <div className="inner is-pcDesignUpdated" >
          ...
          <div className="search-box-wrapper search-box">
            <div id="search_box">
              <form action="/search">
                <input type="text" placeholder="料理名・食材でレシピをさがす" id="query" name="query" value="" ></input>
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="search-icon"  >
                  <path d="M14.0541 14.0536L21 21.0001" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ></path>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.64706 16.2941C12.8704 16.2941 16.2941 12.8704 16.2941 8.64706C16.2941 4.42371 12.8704 1 8.64706 1C4.42371 1 1 4.42371 1 8.64706C1 12.8704 4.42371 16.2941 8.64706 16.2941Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ></path>
                </svg>
              </form>
            </div>
          </div>
